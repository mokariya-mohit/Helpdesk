 ...
 */
$this->assign('title', 'Login - Daily Work Journal');
?>
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (flashHolder.length) {
            ...
            if (msgText) {
                var isErr = flashHolder.find('.error').length > 0 || msgText.toLowerCase().indexOf('error') !== -1 || msgText.toLowerCase().indexOf('invalid') !== -1 || msgText.toLowerCase().indexOf('failed') !== -1;
